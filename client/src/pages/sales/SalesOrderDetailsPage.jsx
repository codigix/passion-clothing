      ...
      <div className="p-2 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-2 mb-2">
          ...
          <div className="bg-white rounded-lg shadow-sm p-2 border border-gray-100 hover:shadow-md transition-all hover:border-green-200">
            ...
            <p className="text-base font-semibold text-green-600">₹{(order.final_amount / 1000).toFixed(1)}K</p>
          </div>
                          ...
                          <tbody className="divide-y divide-gray-100">
                            {order.items.map((item, index) => (
                              <tr key={index} className="hover:bg-blue-50 transition-colors">
                                ...
                                <td className="px-2 py-2 text-gray-700 text-xs">{item.fabric_type || '—'}</td>
                                ...
                                <td className="px-2 py-2 font-semibold text-green-600 text-right text-xs">₹{item.total?.toLocaleString()}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
              ...
              <div className="px-3 pb-3 text-center">
                <p className="text-xs text-gray-600 font-normal">📱 Scan with your phone for live order tracking</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
              ...
              <div className="p-3 space-y-2 text-xs">
                <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-gray-900">₹{(order.final_amount * 0.9).toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center pb-2 border-b border-gray-100">
                  <span className="text-gray-600 font-medium">GST (10%)</span>
                  <span className="font-semibold text-green-600">₹{(order.final_amount * 0.1).toLocaleString()}</span>
                </div>
