                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <div className="font-medium text-gray-900 flex items-center gap-2">
                        ...
                        {stage.is_embroidery && (
                          <span className="text-xs px-2 py-0.5 bg-purple-100 text-purple-700 rounded-full" title="Embroidery Stage">
                            🧵
                          </span>
                        )}
                        {stage.is_printing && (
                          <span className="text-xs px-2 py-0.5 bg-indigo-100 text-indigo-700 rounded-full" title="Printing Stage">
                            🖨️
                          </span>
                        )}
                      </div>
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        {stage.outsourced === true && (
                          <span className="text-xs px-2 py-0.5 bg-orange-100 text-orange-700 rounded-full flex items-center gap-1" title="Outsourced to Vendor">
                            <Building2 className="w-3 h-3" />
                            Outsourced
                          </span>
                        )}
                        {stage.outsourced === false && isOutsourcingStage(stage) && (
                          <span className="text-xs px-2 py-0.5 bg-green-100 text-green-700 rounded-full flex items-center gap-1" title="In-House Production">
                    ...
                    {currentStage.outsourced === true && (
                      <div className="flex items-center gap-2 text-sm">
                        <span className="px-3 py-1.5 bg-orange-100 text-orange-800 rounded-full font-medium flex items-center gap-1">
                          ...
                          Outsourced
                          {currentStage.vendor_id && ` (Vendor #${currentStage.vendor_id})`}
                        </span>
                      </div>
                    )}
                    {currentStage.outsourced === false && isOutsourcingStage(currentStage) && (
                      <div className="flex items-center gap-2 text-sm">
