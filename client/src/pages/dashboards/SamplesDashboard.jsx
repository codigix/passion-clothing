...
const StatCard = ({ title, value, Icon, iconClasses, subtitle }) => (
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    {sampleOrders.map((sample) => (
                      <tr key={sample.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-sm text-gray-700">{sample.customerName}</td>
                        <td className="px-4 py-3 text-sm text-gray-700">{sample.productName}</td>
                        ...
                        <td className="px-4 py-3 text-right text-sm text-gray-700">{sample.quantity}</td>
                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    {sampleTracking.map((track) => (
                      <tr key={track.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3 text-sm text-gray-700">{track.stage}</td>
                        <td className="px-4 py-3 text-sm">
                          <span
                            className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold uppercase ${
                        ...
                        <td className="px-4 py-3 text-sm text-gray-700">{track.startDate}</td>
