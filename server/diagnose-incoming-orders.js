 ...
 * Run from server directory: node diagnose-incoming-orders.js
 */
...
async function diagnose() {
  try {
    ...
    // 7. Count all production orders by status
    console.log('7️⃣  ALL PRODUCTION ORDERS BY STATUS:');
    const allStatusCounts = await ProductionOrder.findAll({
      attributes: [
        'status',
    ...
    console.log('5. Are there ANY production orders matching the incoming filter?\n');
