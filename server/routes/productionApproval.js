...
router.post('/create', authenticateToken, checkDepartment(['manufacturing']), async (req, res) => {
  ...
  try {
    ...
    // Create notification
    const notificationType = approval_status === 'approved' ? 'production_approved' : 'production_rejected';
    ...
    await db.Notification.create({
      ...
      related_type: 'production_approval',
...
// GET /api/production-approval/:verificationId - Get approval by verification ID
