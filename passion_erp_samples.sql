...
CREATE TABLE `samples` (
  ...
  `sample_number` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Format: SMP-YYYYMMDD-XXXX',
  `customer_id` int NOT NULL,
  `product_id` int NOT NULL,
  `sample_type` enum('free','paid','development','approval') COLLATE utf8mb4_unicode_ci NOT NULL,
  `quantity` int NOT NULL DEFAULT '1',
  `specifications` json DEFAULT NULL COMMENT 'Detailed specifications for the sample',
  `cost_per_unit` decimal(10,2) DEFAULT '0.00',
  `total_cost` decimal(10,2) DEFAULT '0.00',
  `selling_price` decimal(10,2) DEFAULT '0.00',
  `status` enum('requested','approved','in_production','ready','dispatched','delivered','approved_by_customer','rejected_by_customer','converted_to_order','cancelled') COLLATE utf8mb4_unicode_ci DEFAULT 'requested',
  ...
  `return_condition` enum('good','damaged','not_returned') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
