...
CREATE TABLE `customers` (
  ...
  `customer_type` enum('individual','business','school','distributor','retailer') COLLATE utf8mb4_unicode_ci NOT NULL,
  `category` enum('regular','premium','vip','wholesale','retail') COLLATE utf8mb4_unicode_ci DEFAULT 'regular',
...
INSERT INTO `customers` VALUES (1,'CUST741746','nitin kamble',NULL,NULL,'Ashwinikhedekar1006@gmail.com','+919112706604',NULL,NULL,NULL,NULL,NULL,'India',NULL,NULL,NULL,'business','regular',NULL,0.00,0,0.00,'active',NULL,NULL,NULL,NULL,NULL,0,0.00,0.00,0,NULL,NULL,2,'2025-10-14 12:42:21','2025-10-14 12:42:21');
...
-- Dump completed on 2025-10-14 23:23:14
