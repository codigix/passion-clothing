...
CREATE TABLE `shipments` (
  ...
  `shipment_number` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Format: SHP-YYYYMMDD-XXXX',
  ...
  `status` enum('preparing','packed','ready_to_ship','shipped','in_transit','out_for_delivery','delivered','failed_delivery','returned','cancelled') COLLATE utf8mb4_unicode_ci DEFAULT 'preparing',
  `shipping_method` enum('standard','express','overnight','same_day','pickup') COLLATE utf8mb4_unicode_ci DEFAULT 'standard',
  `payment_mode` enum('prepaid','cod','credit') COLLATE utf8mb4_unicode_ci DEFAULT 'prepaid',
  ...
  `proof_of_delivery` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Image or document path',
  `delivery_rating` int DEFAULT NULL,
  `delivery_feedback` text COLLATE utf8mb4_unicode_ci,
...
-- Dump completed on 2025-10-14 23:23:16
