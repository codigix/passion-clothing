...
CREATE TABLE `stage_operations` (
  ...
  `status` enum('pending','in_progress','completed','skipped','failed','outsourced','received') COLLATE utf8mb4_unicode_ci DEFAULT 'pending',
  ...
  `work_order_number` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Unique work order number for vendor tracking',
  ...
  `vendor_remarks` text COLLATE utf8mb4_unicode_ci COMMENT 'Communication notes with vendor',
  ...
  `machine_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Machine or equipment used',
  PRIMARY KEY (`id`),
...
INSERT INTO `stage_operations` VALUES (1,15,'Outsourced to 1',0,NULL,'completed',NULL,NULL,NULL,0,0,0,0,NULL,1,2,NULL,NULL,NULL,'2025-10-14 17:45:26','2025-10-14 17:45:45',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
