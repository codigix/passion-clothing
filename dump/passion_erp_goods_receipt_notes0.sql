...
CREATE TABLE `goods_receipt_notes` (
  ...
  `status` enum('draft','received','inspected','approved','rejected','vendor_revert_requested','excess_received') COLLATE utf8mb4_unicode_ci DEFAULT 'draft',
  ...
  `grn_sequence` int NOT NULL DEFAULT '1' COMMENT 'Sequence number for GRN against same PO (1st GRN, 2nd GRN, etc.)',
  `is_first_grn` tinyint(1) NOT NULL DEFAULT '1' COMMENT 'Whether this is the first GRN for the PO',
  `original_grn_id` int DEFAULT NULL COMMENT 'Reference to first GRN when this is a shortage fulfillment GRN',
  `shortage_fulfillment_metadata` json DEFAULT NULL COMMENT 'Metadata for shortage fulfillment: { original_grn_number, vendor_request_id, vendor_request_number, complaint_date }',
  `vendor_id` int DEFAULT NULL COMMENT 'Vendor associated with this GRN (denormalized from PO for reliability)',
  PRIMARY KEY (`id`),
  ...
  KEY `goods_receipt_notes_original_grn_id_foreign_idx` (`original_grn_id`),
  KEY `goods_receipt_notes_vendor_id` (`vendor_id`),
  ...
  CONSTRAINT `goods_receipt_notes_original_grn_id_foreign_idx` FOREIGN KEY (`original_grn_id`) REFERENCES `goods_receipt_notes` (`id`),
  CONSTRAINT `goods_receipt_notes_product_id_foreign_idx` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  CONSTRAINT `goods_receipt_notes_vendor_id_foreign_idx` FOREIGN KEY (`vendor_id`) REFERENCES `vendors` (`id`),
...
INSERT INTO `goods_receipt_notes` VALUES (1,'GRN-20251114-00001',1,NULL,1,'2025-11-14 00:00:00','nitin kamble','INV-12345','DC-12345','[{\"gsm\": \"200\", \"hsn\": \"5208\", \"uom\": \"Meters\", \"rate\": 30, \"color\": \"blue\", \"total\": 6000, \"width\": \"60\", \"weight\": null, \"remarks\": \"\", \"description\": \"\", \"material_name\": \"cotton\", \"quality_status\": \"pending_inspection\", \"discrepancy_flag\": false, \"ordered_quantity\": 200, \"overage_quantity\": 0, \"invoiced_quantity\": 200, \"received_quantity\": 200, \"shortage_quantity\": 0, \"is_shortage_fulfillment\": false}, {\"gsm\": \"200\", \"hsn\": \"5208\", \"uom\": \"Meters\", \"rate\": 30, \"color\": \"white \", \"total\": 6000, \"width\": \"60\", \"weight\": null, \"remarks\": \"\", \"description\": \"\", \"material_name\": \"cotton\", \"quality_status\": \"pending_inspection\", \"discrepancy_flag\": false, \"ordered_quantity\": 200, \"overage_quantity\": 0, \"invoiced_quantity\": 200, \"received_quantity\": 200, \"shortage_quantity\": 0, \"is_shortage_fulfillment\": false}]',12000.00,'inspected',NULL,NULL,6,NULL,NULL,'','[]','verified',6,'2025-11-14 10:39:46','Auto-verified: All items match perfectly (Ordered = Invoiced = Received)',NULL,NULL,NULL,NULL,1,'2025-11-14 10:39:46',0,NULL,NULL,NULL,NULL,NULL,NULL,'2025-11-14 10:39:46','2025-11-14 10:39:46',NULL,NULL,NULL,'pending',NULL,NULL,NULL,1,1,NULL,NULL,1),(2,'GRN-20251119-00001',3,NULL,2,'2025-11-19 00:00:00','nitin kamble',NULL,NULL,'[{\"gsm\": \"\", \"hsn\": \"5208\", \"uom\": \"Boxes\", \"rate\": 100, \"color\": \"\", \"total\": 1300, \"width\": \"\", \"weight\": null, \"remarks\": \"\", \"description\": \"\", \"material_name\": \"button\", \"quality_status\": \"pending_inspection\", \"discrepancy_flag\": true, \"ordered_quantity\": 10, \"overage_quantity\": 3, \"invoiced_quantity\": 10, \"received_quantity\": 13, \"shortage_quantity\": 0, \"is_shortage_fulfillment\": false}]',1300.00,'approved',NULL,NULL,6,NULL,NULL,'','[]','verified',6,'2025-11-19 12:17:42','',NULL,NULL,NULL,NULL,1,'2025-11-19 12:17:42',0,'Credit note generated: CN-20251120-1527 for overage items',NULL,NULL,NULL,NULL,NULL,'2025-11-19 12:17:30','2025-11-20 07:25:20',NULL,NULL,NULL,'pending',NULL,NULL,NULL,1,1,NULL,NULL,1);
...
-- Dump completed on 2025-11-26 17:04:17
