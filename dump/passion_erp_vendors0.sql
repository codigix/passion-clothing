...
CREATE TABLE `vendors` (
  ...
  `vendor_type` enum('material_supplier','outsource_partner','service_provider','both') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `category` enum('fabric','accessories','embroidery','printing','stitching','finishing','transport','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_terms` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `credit_limit` decimal(12,2) DEFAULT '0.00',
  `credit_days` int DEFAULT '0',
  `rating` decimal(3,2) DEFAULT NULL,
  `status` enum('active','inactive','blacklisted') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'active',
...
INSERT INTO `vendors` VALUES (1,'VEN0001','nitin kamble','codigix infotech','Ashwini Khedekar','Ashwinikhedekar1006@gmail.com','09112706604','','Gokul Nagar','Katraj, Pune','Maharashtra','India','411048','','','material_supplier','fabric','',0.00,0,NULL,'active',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,0.00,3,'2025-11-14 08:41:50','2025-11-14 08:41:50');
