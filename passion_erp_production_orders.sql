...
CREATE TABLE `production_orders` (
  ...
  `production_number` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Format: PRD-YYYYMMDD-XXXX',
  ...
  `production_type` enum('in_house','outsourced','mixed') COLLATE utf8mb4_unicode_ci DEFAULT 'in_house',
  ...
  `shift` enum('morning','afternoon','evening','night','day','flexible') COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Production shift schedule',
  `team_notes` text COLLATE utf8mb4_unicode_ci COMMENT 'Notes about team assignments and responsibilities',
  `production_approval_id` int DEFAULT NULL COMMENT 'Link to the production approval that triggered this order',
  `project_reference` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Project reference (usually sales_order_number) for grouping multiple production orders',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2025-10-14 23:23:07
